<?php 
	...
	$firstname = $lastname = $gender = $dob = $bg = $address = $email = $phone  = $uname = $pass   = "";
		...
		if ($_SERVER['REQUEST_METHOD'] === "POST"){
			...
			if($message == ""){
				...
				$flag1 = addmanager($firstname , $lastname , $gender, $dob, $bg, $address, $email, $phone,  $uname, $pass);

				

				if($flag1) {

					$_SESSION['addman'] = "Add Successfully";
					header("Location: ../view/addmanager.php");
				}
			}
			else{
				$_SESSION['addman'] = $message; 
				header("Location: ../view/addmanager.php");
			}
